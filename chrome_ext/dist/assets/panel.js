      ...
      if (Array.isArray(data[keyName])) {
        ...
        if (Array.isArray(value)) {
          for (let j2 = 0; j2 < arrayData.length; j2++) {
            ...
            setValueByPath(entry, keys.slice(i + 1), value[j2]);
          }
        } else {
...
class Chat {
  ...
  async sendMessage(params) {
    ...
    this.sendPromise = (async () => {
      ...
      const outputContent = (_b = (_a22 = response.candidates) === null || _a22 === void 0 ? void 0 : _a22[0]) === null || _b === void 0 ? void 0 : _b.content;
  ...
  async initialize() {
    ...
    for (const mcpClient of this.mcpClients) {
      try {
        ...
        try {
          if (!_d && !_a2 && (_b = _e2.return)) await _b.call(_e2);
        } finally {
          if (e_1) throw e_1.error;
        }
      }
...
class Live {
  ...
  async connect(params) {
    ...
    const onopenAwaitedCallback = function() {
      var _a22;
      (_a22 = callbacks === null || callbacks === void 0 ? void 0 : callbacks.onopen) === null || _a22 === void 0 ? void 0 : _a22.call(callbacks);
      onopenResolve({});
    };
    const apiClient = this.apiClient;
    const websocketCallbacks = {
        ...
        while (remoteCallCount < maxRemoteCalls) {
          ...
          try {
            for (var _f = true, response_1 = (e_1 = void 0, __asyncValues(response)), response_1_1; response_1_1 = yield __await(response_1.next()), _c2 = response_1_1.done, !_c2; _f = true) {
              ...
              const chunk = _e2;
              yield yield __await(chunk);
              if (chunk.candidates && ((_a22 = chunk.candidates[0]) === null || _a22 === void 0 ? void 0 : _a22.content)) {
  ...
  async generateContentStreamInternal(params) {
    ...
    if (this.apiClient.isVertexAI()) {
      ...
      return response.then(function(apiResponse) {
        return __asyncGenerator(this, arguments, function* () {
          var _a22, e_2, _b2, _c2;
          try {
            for (var _d2 = true, apiResponse_1 = __asyncValues(apiResponse), apiResponse_1_1; apiResponse_1_1 = yield __await(apiResponse_1.next()), _a22 = apiResponse_1_1.done, !_a22; _d2 = true) {
            ...
            try {
              if (!_d2 && !_a22 && (_b2 = apiResponse_1.return)) yield __await(_b2.call(apiResponse_1));
            } finally {
      ...
      return response.then(function(apiResponse) {
        return __asyncGenerator(this, arguments, function* () {
          var _a22, e_3, _b2, _c2;
          try {
            for (var _d2 = true, apiResponse_2 = __asyncValues(apiResponse), apiResponse_2_1; apiResponse_2_1 = yield __await(apiResponse_2.next()), _a22 = apiResponse_2_1.done, !_a22; _d2 = true) {
            ...
            try {
              if (!_d2 && !_a22 && (_b2 = apiResponse_2.return)) yield __await(_b2.call(apiResponse_2));
            } finally {
...
class MessageManager {
  ...
  async sendMessage(content) {
    ...
    this.createMessage(d(response.text), "assistant");
  }
  setupVoiceToggle() {
